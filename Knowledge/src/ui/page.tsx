          ...
          <div className="mk-columns">
            <aside className="mk-card mk-base-panel">
              ...
              {visibleBases.map((base) => (
                <div
                  className="mk-base mk-table-row"
                  key={base.id}
                >
                  <input
                    type="checkbox"
  ...
  return (
    ...
    >
      <button
        type="button"
        className={
          open ? "mk-base-select-trigger mk-open" : "mk-base-select-trigger"
        }
      ...
      >
        ...
        <span className="mk-base-select-arrow" aria-hidden="true">
          ⌄
        </span>
      </button>
      {open && (
        <ul className="mk-base-select-list" role="listbox">
          {options.map((option, index) => {
            ...
            return (
              <li
                ...
                className={`mk-base-select-option${isSelected ? " mk-selected" : ""}${index === highlight ? " mk-highlight" : ""}`}
              ...
              >
                ...
                <span className="mk-base-select-check" aria-hidden="true">
                  ✓
                </span>
              </li>
            );
...
.mk-columns{display:grid;grid-template-columns:270px minmax(0,1fr);gap:18px}.mk-base{display:flex;align-items:center;gap:10px;padding:6px;border-radius:8px}.memmy-knowledge .mk-base-name{border:0;text-align:left;white-space:normal;overflow-wrap:anywhere;flex:1}.mk-add{border-top:1px solid #8883;margin-top:20px;padding-top:16px}.mk-empty{padding:30px 0;text-align:center;opacity:.6;line-height:1.7}
...
.mk-detail-modal .mk-file-header{position:relative;padding-top:58px;padding-bottom:28px;border-bottom:1px solid #eee}.mk-detail-modal .mk-close{position:absolute;left:0;top:12px;width:40px;height:40px;display:flex;align-items:center;justify-content:center;border-radius:10px!important;background:#f7f8f8!important;font-size:28px!important;line-height:1;z-index:5;cursor:pointer;pointer-events:auto}.mk-detail-modal .mk-close:hover{background:#e8f6f3!important;color:#2d8f81}.mk-detail-modal .mk-file-header h2{margin:0;font-size:22px;line-height:1.25}.mk-detail-modal .mk-detail-recall{margin-top:24px}
.mk-select-field{display:grid;gap:7px;font-size:13px}.mk-base-select{position:relative}.mk-base-select-trigger{display:flex;align-items:center;justify-content:space-between;gap:10px;width:100%;box-sizing:border-box;border:1px solid #d9deda!important;border-radius:9px!important;padding:9px 12px;background:#fff!important;color:inherit;font-size:14px;text-align:left;cursor:pointer;white-space:nowrap}.mk-base-select-trigger:hover{background:#f7faf9!important}.mk-base-select-trigger.mk-open,.mk-base-select-trigger:focus-visible{border-color:#46b6a5!important;box-shadow:0 0 0 3px #46b6a522}.mk-base-select-trigger>span:first-child{overflow:hidden;text-overflow:ellipsis}.mk-base-select-arrow{font-size:15px;opacity:.55;flex-shrink:0;transition:transform .15s ease}.mk-base-select-trigger.mk-open .mk-base-select-arrow{transform:rotate(180deg)}.mk-base-select-list{position:absolute;left:0;right:0;top:calc(100% + 6px);z-index:10;margin:0;padding:5px;list-style:none;background:var(--background-primary,#fff);border:1px solid #e3e8e5;border-radius:10px;box-shadow:0 10px 32px #18212b22;max-height:220px;overflow:auto}.mk-base-select-option{display:flex;align-items:center;justify-content:space-between;gap:10px;padding:8px 10px;border-radius:7px;font-size:13px;cursor:pointer}.mk-base-select-option:hover,.mk-base-select-option.mk-highlight{background:#f0f7f5}.mk-base-select-option.mk-selected{color:#2d8f81;font-weight:600}.mk-base-select-check{color:#46b6a5;font-size:13px;opacity:0;flex-shrink:0}.mk-base-select-option.mk-selected .mk-base-select-check{opacity:1}
